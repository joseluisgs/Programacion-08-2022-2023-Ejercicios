...
object ConfigApp {
    ...
    private var _APP_INIT_DATABASE: Boolean = true
    val APP_INIT_DATABASE get() = _APP_INIT_DATABASE
    ...
    private fun loadProperties() {
        ...
        _APP_NAME = properties.getProperty("APP_NAME") ?: "IngredientesBD_SQLDelight-Kotlin"
        ...
        _APP_URL = properties.getProperty("APP_URL") ?: "jdbc:sqlite:ingredientes.db"
        _APP_INIT_DATABASE = (properties.getProperty("APP_INIT_DATABASE") ?: "true") == "true"
    }
