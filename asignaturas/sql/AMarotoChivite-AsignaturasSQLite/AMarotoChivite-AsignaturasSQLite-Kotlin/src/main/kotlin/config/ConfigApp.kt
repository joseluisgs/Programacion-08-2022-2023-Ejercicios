...
object ConfigApp {
    ...
    fun getPathDataOutput(prefix: String, extension: String): String {
        return _dataOutputPath + "${prefix}.${extension}"
    }

    private var _dataInputPath: String = "" // Ruta de la carpeta donde importaremos datos
    fun getPathDataInput(prefix: String, extension: String): String {
        return _dataInputPath + "${prefix}.${extension}"
    }
